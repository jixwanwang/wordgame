...
export function GameOverModal({
  ...
  const shareText = currentStreak > 0? `Crosses#${puzzleNumber} - ${numGuesses}|${totalLettersRevealed} 🔥${currentStreak}` : `Crosses#${puzzleNumber} - ${numGuesses}|${totalLettersRevealed}`;
        ...
        <div className="space-y-4 flex flex-col items-center">
          ...
          >
            {copied ? "Copied!" : "Share Results"}
                ...
                <div>
                    <div>{numGuesses} / {NUM_GUESSES} guesses used</div>
